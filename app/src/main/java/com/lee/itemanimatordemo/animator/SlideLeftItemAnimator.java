...
public class SlideLeftItemAnimator extends BaseItemAnimator {
    ...
    void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0).translationX(view.getRootView().getWidth()).setListener(
                new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationStart(Animator animator) {
                        Log.i("animation", "Slide Remove Start");
                        dispatchRemoveStarting(holder);
                    }

                    @Override
                    public void onAnimationEnd(Animator animator) {
                        Log.i("animation", "Slide Remove End");
                        animation.setListener(null);
                        view.setTranslationX(0);
                        view.setAlpha(1);
